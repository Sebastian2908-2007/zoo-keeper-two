...
// function for getting all animals or animals based on form data
const getAnimals = (formData = {}) => {
  let queryUrl = '/api/animals?';

  // will package data from handleGetAnimalsSubmit() and turn it into our query url if form data not submitted then queryUrl remains /api/animals
